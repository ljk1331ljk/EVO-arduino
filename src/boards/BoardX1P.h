#ifndef EVO_BOARD_X1P_H
#define EVO_BOARD_X1P_H

#include "BoardDefinition.h"

/*
 * Initial X1P board definition.
 *
 * The EVO-arduino repository currently does not contain a separate X1P
 * pin map. The values below intentionally mirror the existing X1E V3.0
 * map so the multi-board architecture can compile immediately.
 *
 * Change only this file when the confirmed X1P schematic/pin map is
 * available.
 */
struct BoardX1P
{
    static constexpr EvoBoardId ID = EvoBoardId::X1P;
